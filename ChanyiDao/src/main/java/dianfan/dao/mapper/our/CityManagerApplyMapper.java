 ...
 */
@Repository
public interface CityManagerApplyMapper {
	/**
	 * @Title: addCoopereApply
	 * @Description: 申请成为城市经理
	 * @param CityManagerApply
	 * @throws:
	 * @time: 2018年6月30日 下午4:08:22
	 */
	void addCityManagerApply(CityManagerApply cityManagerApply);
	 ...
	 */
	void updateCityManagerApply(CityManagerApply cityManagerApply);
	/**
	 ...
	 */
	void updateCityManagerApplyStatus(CityManagerApply cityManagerApply);
	
	/**
	 * @Title: getCityManagerApply
	 * @Description: 
	 * @param userid 用户id
	 * @return
	 * @throws:
	...
	/**
	 * @Title: getCityManagerApplyByPhone
	 * @Description: 
	 * @param phonenum 手机号码
	 * @return
	 * @throws:
	 ...
	 */
	int getCityManagerApplyByPhone(String phonenum);
	/**
	 * @Title: getUserRole
	 * @Description: 
	...
	/**
	 * @Title: updateCityManagerApplyRole
	 * @Description: 
	 * @param cam
	 * @throws:
	 * @time: 2018年7月3日 下午7:09:47
	 */
	void updateCityManagerApplyRole(UserRole cam);
	/**
	 * @Title: getVersionInfo
	 * @Description: 获取当前版本信息（城市经理）
	 * @param userid 用户id
	 * @return
	 * @throws:
	 * @time: 2018年7月13日 下午3:12:31
	 */
	@Select("select version from t_citymanager_apply where apply_user_id=#{userid}")
	int getVersionInfo(String userid);
	/**
	 * @Title: getCityManageApplyUserid
	 * @Description: 
	 * @param citymanagerid
	 * @return
	 * @throws:
	 * @time: 2018年8月2日 下午6:06:48
	 */
	@Select("select apply_user_id from t_citymanager_apply where id= #{citymanagerid}")
	String getCityManageApplyUserid(String citymanagerid);
	/**
	 ...
	 * @Description: 根据条件获取城市经理人数
	 * @return
	 * @throws:
	 * @time: 2018年7月23日 上午10:49:47
	 */
	int getCityManagerNum(CityManagerModel ca);
	/**
	 * @Title: getOperateServicer
	 * @Description: 获取城市经理信息
	 * @param operaserverid 城市经理id
	 * @return
	 * @throws:
	 * @time: 2018年7月28日 下午5:03:56
	 */
	CityManagerApply getCityManagerInfo(String citymanagerid);
	/**
	 ...
	 */
	List<CityManagerModel> findCityManagerApplyList(CityManagerModel ca);
	/**
